import { Product, Transaction, TabType, Employee, AttendanceRecord } from '../types';
...
export const DashboardView: React.FC<DashboardViewProps> = ({
  ...
  const activeCashiersCount = attendanceLogs.filter(
    (log) => log.date === todayStr && (log.status === 'Checked In' || log.status === 'Late' || log.status === 'On Break')
  ).length;
